...
#!homepage=https://raw.gitbubusercontent.com/ShAlIow/something/Loon/chajian/autorenewptkey.plugin
#!icon=
#!tag = 增强功能
#!input = qinglongHost
#!input = clientId
...
[Script]
http-response ^https?:\/\/api\.m\.jd\.com\/client\.action\?functionId=(wareBusiness|serverConfig|basicConfig) script-path=https://raw.gitbubusercontent.com/ShAlIow/something/Loon/ptkey.js,requires-body=true,tag=JD Cookie Script,enable=true
